...
In this chapter, detailed description of each implemented network is presented. All typologies were designed to be as similar as possible, with the only exception for details characteristic for given method. In case of methods incorporating autoencoders approach, size of encoded latent face was set to 200.\\
