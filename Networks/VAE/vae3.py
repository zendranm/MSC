...
deepfake_path = 'C:/Users/michal/Desktop/DiCaprioToDowneyJr_test.npz'
(train_images, _), (test_images, _) = load_mnist(deepfake_path)
...
def compute_loss(model, x):
  ...
  print("aaaa: "+ str(z.shape))
  x_logit = model.decode(z)

  print("\n\n------------------------------------")
  print(x_logit.get_shape())
  print(x.get_shape())
  print("------------------------------------\n\n")
